...
for run in ${arr[*]}; do 
	cdo detrend HadCM3/surface_temperature/surfa"$run".nc tmp_"$run".nc
...
for run in ${arr[*]}; do 
	cdo detrend HadCM3/sea_ice/sea_i"$run".nc tmp_"$run".nc
...
for run in ${arr[*]}; do 
	cdo detrend HadCM3/precipitation/preci"$run".nc tmp_"$run".nc
...
#for run in ${arr[*]}; do 
#	cdo detrend HadCM3/sea_level_pressure/sea_l"$run".nc tmp_"$run".nc
#	cdo ymonsub tmp_"$run".nc -ymonmean tmp_"$run".nc HadCM3/precipitation/stationary/"$run".nc
#	rm tmp*
#done
...
#for run in ${arr[*]}; do 
#	cdo detrend HadCM3/wind/wind_"$run".nc tmp_"$run".nc
